...
<?php includeWithVariables("head.php", array('title' => 'Standard and Genetic Concerns - Skyline Giant Schnauzers'))?>

<body>
    <!-- Header -->
    <?php includeWithVariables("header.php", array('headerClass' => 'standard-genetic-header', 'headerHTML' => '<h1>Standard and Genetic Concerns</h1>'));?>
    ...
    <section class="content-section-a bg-color">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="text-left">
                    <div>Hip dysplasia</div>
                    <div>Hypothyroidism</div>
                    <div>Malabsorption of cobalmin</div>
                    <div>Osteochondritis dissecans</div>
                    <div>Seborrhea</div>
                    <div>Von Willebrand's disease</div>
                    <div>Epilepsy</div>
                    <div>Cancer/Toe Cancer</div>
                    <div>Auto-Immune Mediated Hemolytic Anemia (AIHA)</div>
                </div>
            </div>
            <div class="row">
                <h1 class="margin-top">Breed Standard</h1>
            </div>
            <div class="row">
                <h4 class="margin-top-small">General Description</h4>
            </div>
            <div class="row">
                <div class="text-left">
            ...
            <div class="row justify-content-center margin-top-small">
                <img class="img-fluid lazy" sizes="(max-width: 400px) 100vw, 400px" data-srcset="
            ...
            <div class="row">
                <h4 class="margin-top-small">Forequarters</h4>
            </div>
            <div class="row">
                <div class="text-left">
            ...
            <div class="row">
                <h4 class="margin-top-small">Back</h4>
            </div>
            <div class="row">
                <div class="text-left">
            ...
            <div class="row">
                <h4 class="margin-top-small">Tail</h4>
            </div>
            <div class="row">
                <div class="text-left">
            ...
            <div class="row">
                <h4 class="margin-top-small">Hindquarters</h4>
            </div>
            <div class="row">
                <div class="text-left">
            ...
            <div class="row">
                <h4 class="margin-top-small">Coat</h4>
            </div>
            <div class="row">
                <div class="text-left">
            ...
            <div class="row">
                <h4 class="margin-top-small">Color</h4>
            </div>
            <div class="row">
                <div class="text-left">
            ...
            <div class="row">
                <h4 class="margin-top-small">Height</h4>
            </div>
            <div class="row">
                <div class="text-left">
            ...
            <div class="row">
                <h4 class="margin-top-small">Faults</h4>
            </div>
            <div class="row">
                <div class="text-left">
                    <div>The foregoing description is that of the ideal Giant Schnauzer. Any deviation from the above
                        described dog must be penalized to the extent of the deviation.</div>
                    <div>The judge shall dismiss from the ring any shy or vicious Giant Schnauzer.</div>
                    <div>Shyness A dog shall be judged fundamentally shy if, refusing to stand for examination, it
                        ...
                        belligerent attitude towards other dogs shall not be deemed viciousness.</div>
                </div>
            </div>

            <div class="row">
                <h4 class="margin-top-small">Disqualifications</h4>
            </div>
            <div class="row">
                <div class="text-left">
                    <div>Overshot or undershot.</div>
                    <div>Markings other than specified.</div>
                </div>
            </div>
            <div class="row">
                <h4 class="margin-top-small">Approved October 11, 1983</h4>
            </div>
        </div>
    </section>
