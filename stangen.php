...
<html lang="en">
  ...
  <head>
    ...
    <title>Standard and Genetic Concerns - Skyline Giant Schnauzers</title>
  ...
  <body>
    ...
    <header class="standard-genetic-header">
      <div class="container">
        <div class="intro-message">
          <h1>Standard and Genetic Concerns</h1>
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="text-left">
            <div>The foregoing description is that of the ideal Giant Schnauzer. Any deviation from the above described dog must be penalized to the extent of the deviation.</div>
            <div>The judge shall dismiss from the ring any shy or vicious Giant Schnauzer.</div>
            <div>Shyness A dog shall be judged fundamentally shy if, refusing to stand for examination, it repeatedly shrinks away from the judge; if it fears unduly any approach from the rear; if it shies to a marked degree at sudden and unusual noises. Viciousness A dog that attacks or attempts to attack either the judge or its handler, is definitely vicious. An aggressive or belligerent attitude towards other dogs shall not be deemed viciousness.</div>
          </div>
        </div>
