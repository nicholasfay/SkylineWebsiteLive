...
<html lang="en">
  ...
  <body>
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"Leaving my puppy prints in the sand"</p>
        </div>
        <div class="row">
          <div class="descript">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"We are so happy with him and so amazed"</p>
        </div>
        <div class="row">
          <div class="descript">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"Emily and her new Skyline pup Macy"</p>
        </div>
        <div class="row">
          <div class="descript">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"Carly with her new family."</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-4">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"As for Graham and me, Denali is the love of our lives."</p>
        </div>
        <div class="row">
          <div class="descript">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"He plays and romps but doesn't miss a trick."</p>
        </div>
        <div class="row">
          <div class ="descript">
            ...
            <div class="descript">- Alan Witkin</div>
          </div>
        </div>
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">""Winzig" and the boys he owns"</p>
        </div>
        <div class="row">
          <div class="descript">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"They are such an important part of our family!"</p>
        </div>
        <div class="row">
          <div class="descript">
    ...
    <section class="content-section-a bg-color">
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"We are looking forward to many more years with him."</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-4">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"Training has resulted in a very people and other dog friendly guy"</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-3">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"Giant Schnauzer from a wonderful breeder"</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-2">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"I'll be with you 'til the end, Coop."</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-3">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"Where do I begin…there is so much to say and love about our two Skyline Giants."</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-2">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="font-italic text-secondary large2">"Minka is everything a Giant should be: strong, loyal, loving, adventurous, a little mischievous, and so incredibly smart."</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-2">
