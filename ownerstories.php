...
<html lang="en">
  ...
  <head>
    ...
    <title>Owner Stories - Skyline Giant Schnauzers</title>
  ...
  <body>
    ...
    <header class="ownerstories-header">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="descript">
            ...
            He's very fit and strong. He can jump and catch his rope toys at great height and enjoys playing and running. We have a 5 1/2 foot tall aluminum fence enclosing about a half acre of our property. It is a beautiful sight when we watch him run. He walks several miles twice a day in our development and is a joy on leash. He has not reached off leash level yet and we wouldn't have him off leash in public anyway.

            People are always excited to see him and he gets a lot of attention when he's out and about. Here are a few pictures we've taken over time.
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="descript">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <ol class="descript some-padding-left">
            ...
            <li>Does not like any vehicles driving by the house that have things on their roof (taxi cabs, pizza delivery cars, ladder trucks)</li>
            <li>If he does something naughty or you get irritated, he'll climb on your lap, holding you down and will lick your face until you laugh and tell him he's a good boy</li>
          </ol>
        </div>
        <div class="row justify-content-center">
          <div class="descript">
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="text-secondary large2">"Where do I begin…there is so much to say and love about our two Skyline Giants."</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-2">
          <img class="img-fluid lazy" sizes="(max-width: 600px) 100vw, 600px"
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="text-secondary large2">"Minka is everything a Giant should be: strong, loyal, loving, adventurous, a little mischievous, and so incredibly smart."</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-2">
          <img class="img-fluid lazy" sizes="(max-width: 600px) 100vw, 600px"
    ...
    <section class="content-section-a bg-color">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <p class="text-secondary large2">"I always wanted a giant schnauzer, from seeing them at a dog show years back. It was finally time!"</p>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-2">
          <img class="img-fluid lazy" sizes="(max-width: 600px) 100vw, 600px"
