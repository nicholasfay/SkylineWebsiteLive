...
<?php includeWithVariables("head.php", array('title' => 'Useful Links - Skyline Giant Schnauzers'))?>

<body class="bg-color">

    <!-- Header -->
    <?php includeWithVariables("header.php", array('headerClass' => 'useful-links-header', 'headerHTML' => "<h1>Skyline Giant Schnauzers' Useful Links</h1>"));?>
    ...
    <section class="content-section-a bg-color margin-left">
        <ul class="list-group list-group-flush ">
            ...
            <a href="http://www.dogsnaturallymagazine.com/spay-neuter-and-joint-disease/"
