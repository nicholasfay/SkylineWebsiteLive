    ...
    <header class="aboutus-header">
      <div class="container">
        <div class="intro-message">
          <h1>Aboowut Skyline Giant Schnauzers and The Humans They Own</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class ="descript">
					...
					Puppies are available to selected show and pet homes. All puppies have Ofa certified or XRAY cleared parents. All pet/companion puppies are placed with a spay/neuter contract and a limited registration with the American Kennel Club.
					</div>
